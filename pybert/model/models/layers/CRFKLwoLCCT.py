...
class CRF(nn.Module):
    ...
    def _compute_normalizer(self, emissions: torch.Tensor,
        ...
        for i in range(1, seq_length):
            ...
            next_score = broadcast_score + self.transitions_prime + broadcast_emissions
    ...
    def _viterbi_decode(self, emissions: torch.FloatTensor,
        ...
        for i in range(1, seq_length):
            ...
            next_score = broadcast_score + self.transitions_prime + broadcast_emission
    ...
    def _viterbi_decode_nbest(self, emissions: torch.FloatTensor,
        ...
        for i in range(1, seq_length):
            if i == 1:
                ...
                next_score = broadcast_score + self.transitions_prime.unsqueeze(1) + broadcast_emission
